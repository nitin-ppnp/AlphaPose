...
class DetectionLoader:
    def __init__(self, batchSize=1, queueSize=1024):
        # initialize the file video stream along with the boolean
        # used to indicate if the thread should be stopped or not
        dirname = os.path.dirname(__file__)
        self.det_model = Darknet(os.path.join(dirname,"yolo/cfg/yolov3-spp.cfg"))
        self.det_model.load_weights(os.path.join(dirname,'models/yolo/yolov3-spp.weights'))
    ...
    def forward(self,img,orig_img,im_dim_list):
        ...
        return orig_img, boxes_k, scores[dets[:,0]==k], inps, pt1, pt2
...
class DetectionProcessor:
    ...
    def forward(self,img,orig_img,im_dim_list):
        ...
        for i in range(self.datalen):
            ...
            with torch.no_grad():
                (orig_img, boxes, scores, inps, pt1, pt2) = self.detectionLoader.forward(img,orig_img,im_dim_list)
